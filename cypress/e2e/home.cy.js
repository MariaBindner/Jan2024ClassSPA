...
describe("Verify Home View Elements", () => {
  ...
  it("verifies alert button functionality", () => {
    ...
    //  perform an actual mouse click to trigger the behavior, but it won't be able to actually see the Alert Box itself.
  ...
  it("verifies correct display of jumbotron background", () => {
    cy.get("#jumbotron").should(
      "have.css",
      "background-image",
      `url("${Cypress.env(
        "ROOT_URL"
      )}/photo-1528334713982-2d1fe11a157a.b47d623e.jpg")`
    );
  });
